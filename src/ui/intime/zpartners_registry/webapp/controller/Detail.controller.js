            ...
            onCreateJiraProjectButtonPress: function (oEvent) {
                ...
                this.getModel().callFunction("/CreateJiraProject", {
                    ...
                    success: function (oData) {
                        ...
                        this.getModel().setProperty(this.byId("stageForm").getBindingContext().getPath() + "/JiraProjectID", oData.CreateJiraProject.JiraProjectID);
                        this.getModel().setProperty(this.byId("stageForm").getBindingContext().getPath() + "/JiraProjectName", oData.CreateJiraProject.JiraProjectName);
                        this.getModel().setProperty(this.byId("stageForm").getBindingContext().getPath() + "/JiraProjectStage", oData.CreateJiraProject.JiraProjectStage);
